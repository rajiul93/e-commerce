...
const Cart = () => {
    ...
    for(let key in savedCart){
        cart.push({...product.find(pd=>pd.id ===key),
                ...
                <div className="container mt-5">
                   ...
                   <div className="col-lg-9">
                    ...
                    <div className="col-lg-3">
                        ...
                        <div className='py-2' style={{border:"1px solid gray", borderTop:"0"}}>
                            <button id='btn_check_out' onClick={()=>handelClick()} className="btn btn-secondary mx-auto d-block" disabled={disable}>Proceed to Checkout</button>
                        </div>
                    </div>
                   </div>
                </div>
